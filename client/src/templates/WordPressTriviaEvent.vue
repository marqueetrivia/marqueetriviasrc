<template>
  <Layout>
    <main :class="['trivia-event', event.slug]">
        ...
        <div class="grid">
          <div class="grid-1of3 grid-1of1--notebook-large section section--red">
            <div class="trivia-event__header__title">
              ...
              <p v-if="event.acf" class="date">
                {{ eventDate }}
              </p>
              <p v-if="event.acf" class="location">
                <a
                  v-if="event.acf.location.address"
                  :href="
                    `https://maps.google.com/?q=${event.acf.location.address}`
                  "
                  rel="no-openner"
                  target="_blank"
                >
            ...
            <div v-if="event.acf" class="trivia-event__header__ctas">
              <a
          ...
          <div class="grid-2of3 grid-1of1--notebook-large">
            <div
              ...
              :style="{
                backgroundImage: `url(/triviaevents${event.acf.photoAsset})`
              }"
            ></div>
          </div>
        </div>
      ...
      <section class="section section--yellow trivia-event__rules">
        <div class="container">
          ...
          <ul class="rules">
            ...
            <li class="rules__rule">
              Teams are limited to groups of six (teams larger than that are not
              eligible to win prizes, but can still play!)
            </li>
            <li class="rules__rule">
            ...
            <li class="rules__rule">
              Unless otherwise stated; voice work and cameos count for questions
              about actors
            </li>
            <li class="rules__rule">
              Unless otherwise stated; box office stats are not adjusted for
              inflation and are domestic
            </li>
            <li class="rules__rule">
              Unless otherwise stated; Oscars round are regarding the release
              year of the film(s)
            </li>
          </ul>
        </div>
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          ...
          content:
            "Boston’s first trivia night for film lovers. Every month we dive into movie marginalia, Oscars history, box office stats, and more!"
        },
        {
          property: "og:url",
